...
-keep class com.vkas.secondtranslation.stbean.StAdBean { *; }
-keep class com.vkas.secondtranslation.stbean.StDetailBean { *; }
-keep class com.vkas.secondtranslation.stbean.Language { *; }